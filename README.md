...
| 方法 | 功能 | 需要信息 |
|------|------|---------|
| **八字命理** | 四柱排盘、十神、藏干、五行、大运、格局、用神 | 出生时间、性别 |
| **紫微斗数** | 12宫、主星、四化、大限、流年 | 出生时间、性别 |
| **奇门遁甲** | 9宫、八门、九星、八神、用神定位 | 出生时间 |
| **称骨算命** | 骨重计算、批语 | 出生时间 |
| **数字命理** | 五格剖象法、生命数 | 姓名、出生时间 |
| **梅花易数** | 时间起卦、体用生克、互卦变卦 | 出生时间 |
| **六爻排盘** | 六爻、世应、六神、纳甲 | 出生时间 |
| **大六壬** | 月将加时、四课三传、天将 | 出生时间 |
| **金口诀** | 四柱起课、五行生克 | 出生时间 |
| **西方占星** | 太阳/月亮/上升星座、四元素 | 出生时间 |
| **吠陀占星** | 恒星黄道、Nakshatra、Tithi | 出生时间 |
